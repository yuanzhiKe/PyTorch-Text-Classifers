...
parser.add_argument('--Kernel_sizes', default=None, nargs='+', type=int, help='width of the convolutional kernels in each block. Default is [3,4,5]')
...
model = PCNN(vocab_size, emb_dim, hidden_dim, max_length, tag_size, padding_idx, pooling_size=pooling_size, block_sets=kernel_sizes)
